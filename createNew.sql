...
GO
/****** Object:  Table [dbo].[tblCarts]    Script Date: 03/04/25 11:13:01 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblCategories]    Script Date: 03/04/25 11:13:01 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblDiscounts]    Script Date: 03/04/25 11:13:01 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblOrderDetails]    Script Date: 03/04/25 11:13:01 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblOrders]    Script Date: 03/04/25 11:13:01 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblPayments]    Script Date: 03/04/25 11:13:01 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblProductDetails]    Script Date: 03/04/25 11:13:01 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblProducts]    Script Date: 03/04/25 11:13:01 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblProductViews]    Script Date: 03/04/25 11:13:01 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblReviews]    Script Date: 03/04/25 11:13:01 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblRoles]    Script Date: 03/04/25 11:13:01 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblShipping]    Script Date: 03/04/25 11:13:01 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblUsers]    Script Date: 03/04/25 11:13:01 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblWishlist]    Script Date: 03/04/25 11:13:01 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [usingDate]) VALUES (1, N'MSI Katana GF66', N'msi_katana.jpg', CAST(23990.00 AS Decimal(10, 2)), 18, N'C001', N'B007', CAST(N'2023-03-15' AS Date), CAST(N'2026-03-15' AS Date))
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [usingDate]) VALUES (2, N'Acer Nitro 5', N'acer_nitro5.jpg', CAST(20990.00 AS Decimal(10, 2)), 25, N'C001', N'B005', CAST(N'2023-05-10' AS Date), CAST(N'2026-05-10' AS Date))
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [usingDate]) VALUES (3, N'Asus TUF Gaming F15', N'asus_tuf_f15.jpg', CAST(22990.00 AS Decimal(10, 2)), 22, N'C001', N'B002', CAST(N'2023-06-18' AS Date), CAST(N'2026-06-18' AS Date))
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [usingDate]) VALUES (4, N'Dell G15', N'dell_g15.jpg', CAST(21990.00 AS Decimal(10, 2)), 20, N'C001', N'B003', CAST(N'2023-07-25' AS Date), CAST(N'2026-07-25' AS Date))
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [usingDate]) VALUES (5, N'Lenovo Legion 5', N'lenovo_legion5.jpg', CAST(25990.00 AS Decimal(10, 2)), 20, N'C001', N'B001', CAST(N'2023-01-01' AS Date), CAST(N'2026-01-01' AS Date))
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [usingDate]) VALUES (6, N'Asus ROG Zephyrus G14', N'asus_zephyrusg14.jpg', CAST(32990.00 AS Decimal(10, 2)), 15, N'C001', N'B002', CAST(N'2023-02-01' AS Date), CAST(N'2026-02-01' AS Date))
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [usingDate]) VALUES (7, N'Lenovo ThinkPad X1 Carbon', N'lenovo_x1carbon.jpg', CAST(35990.00 AS Decimal(10, 2)), 15, N'C002', N'B001', CAST(N'2023-04-05' AS Date), CAST(N'2027-04-05' AS Date))
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [usingDate]) VALUES (8, N'HP Spectre x360', N'hp_spectrex360.jpg', CAST(32990.00 AS Decimal(10, 2)), 18, N'C002', N'B004', CAST(N'2023-05-12' AS Date), CAST(N'2027-05-12' AS Date))
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [usingDate]) VALUES (9, N'Dell Latitude 7420', N'dell_latitude7420.jpg', CAST(29990.00 AS Decimal(10, 2)), 20, N'C002', N'B003', CAST(N'2023-06-20' AS Date), CAST(N'2026-06-20' AS Date))
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [usingDate]) VALUES (10, N'Asus ExpertBook B9', N'asus_expertbookb9.jpg', CAST(27990.00 AS Decimal(10, 2)), 22, N'C002', N'B002', CAST(N'2023-07-15' AS Date), CAST(N'2026-07-15' AS Date))
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [usingDate]) VALUES (11, N'LG Gram 17', N'lg_gram17.jpg', CAST(26990.00 AS Decimal(10, 2)), 16, N'C002', N'B009', CAST(N'2023-08-22' AS Date), CAST(N'2026-08-22' AS Date))
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [usingDate]) VALUES (12, N'Dell XPS 13', N'dell_xps13.jpg', CAST(28990.00 AS Decimal(10, 2)), 25, N'C002', N'B003', CAST(N'2023-03-01' AS Date), CAST(N'2026-03-01' AS Date))
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [usingDate]) VALUES (13, N'HP Envy 15', N'hp_envy15.jpg', CAST(23990.00 AS Decimal(10, 2)), 30, N'C002', N'B004', CAST(N'2023-04-01' AS Date), CAST(N'2026-04-01' AS Date))
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [usingDate]) VALUES (14, N'HP Pavilion Aero 13', N'hp_pavilion_aero.jpg', CAST(19990.00 AS Decimal(10, 2)), 30, N'C003', N'B004', CAST(N'2023-06-10' AS Date), CAST(N'2025-06-10' AS Date))
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [usingDate]) VALUES (15, N'Acer Swift 5', N'acer_swift5.jpg', CAST(21990.00 AS Decimal(10, 2)), 28, N'C003', N'B005', CAST(N'2023-07-18' AS Date), CAST(N'2025-07-18' AS Date))
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [usingDate]) VALUES (16, N'Asus ZenBook 14', N'asus_zenbook14.jpg', CAST(23990.00 AS Decimal(10, 2)), 22, N'C003', N'B002', CAST(N'2023-08-25' AS Date), CAST(N'2025-08-25' AS Date))
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [usingDate]) VALUES (17, N'Dell Inspiron 14', N'dell_inspiron14.jpg', CAST(18990.00 AS Decimal(10, 2)), 35, N'C003', N'B003', CAST(N'2023-09-12' AS Date), CAST(N'2025-09-12' AS Date))
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [usingDate]) VALUES (18, N'Acer Swift 3', N'acer_swift3.jpg', CAST(18990.00 AS Decimal(10, 2)), 40, N'C003', N'B005', CAST(N'2023-05-01' AS Date), CAST(N'2025-05-01' AS Date))
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [usingDate]) VALUES (19, N'MacBook Air', N'macbook_air.jpg', CAST(27990.00 AS Decimal(10, 2)), 35, N'C003', N'B006', CAST(N'2023-06-01' AS Date), CAST(N'2026-06-01' AS Date))
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [usingDate]) VALUES (20, N'MSI Creator Z16', N'msi_creatorz16.jpg', CAST(46990.00 AS Decimal(10, 2)), 8, N'C004', N'B007', CAST(N'2023-06-05' AS Date), CAST(N'2027-06-05' AS Date))
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [usingDate]) VALUES (21, N'HP ZBook Studio', N'hp_zbookstudio.jpg', CAST(44990.00 AS Decimal(10, 2)), 10, N'C004', N'B004', CAST(N'2023-08-20' AS Date), CAST(N'2027-08-20' AS Date))
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [usingDate]) VALUES (22, N'Acer ConceptD 7', N'acer_conceptd7.jpg', CAST(42990.00 AS Decimal(10, 2)), 12, N'C004', N'B005', CAST(N'2023-09-15' AS Date), CAST(N'2027-09-15' AS Date))
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [usingDate]) VALUES (23, N'Asus ProArt StudioBook', N'asus_proart.jpg', CAST(48990.00 AS Decimal(10, 2)), 7, N'C004', N'B002', CAST(N'2023-10-22' AS Date), CAST(N'2028-10-22' AS Date))
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [usingDate]) VALUES (24, N'Dell XPS 17', N'dell_xps17.jpg', CAST(43990.00 AS Decimal(10, 2)), 12, N'C005', N'B003', CAST(N'2023-07-01' AS Date), CAST(N'2027-07-01' AS Date))
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [usingDate]) VALUES (25, N'HP Spectre Folio', N'hp_spectrefolio.jpg', CAST(40990.00 AS Decimal(10, 2)), 15, N'C005', N'B004', CAST(N'2023-08-10' AS Date), CAST(N'2027-08-10' AS Date))
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [usingDate]) VALUES (26, N'Lenovo ThinkPad X1 Extreme', N'lenovo_x1extreme.jpg', CAST(45990.00 AS Decimal(10, 2)), 10, N'C005', N'B001', CAST(N'2023-09-18' AS Date), CAST(N'2027-09-18' AS Date))
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [usingDate]) VALUES (27, N'MSI Prestige 14', N'msi_prestige14.jpg', CAST(38990.00 AS Decimal(10, 2)), 14, N'C005', N'B007', CAST(N'2023-11-12' AS Date), CAST(N'2027-11-12' AS Date))
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [usingDate]) VALUES (28, N'MacBook Pro 16', N'macbook_pro16.jpg', CAST(55990.00 AS Decimal(10, 2)), 8, N'C005', N'B006', CAST(N'2023-10-01' AS Date), CAST(N'2028-10-01' AS Date))
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [usingDate]) VALUES (29, N'Lenovo ThinkPad P15', N'lenovo_thinkpadp15.jpg', CAST(52990.00 AS Decimal(10, 2)), 8, N'C007', N'B001', CAST(N'2023-09-05' AS Date), CAST(N'2028-09-05' AS Date))
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [usingDate]) VALUES (30, N'HP ZBook Fury 17', N'hp_zbookfury17.jpg', CAST(58990.00 AS Decimal(10, 2)), 6, N'C007', N'B004', CAST(N'2023-10-12' AS Date), CAST(N'2028-10-12' AS Date))
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [usingDate]) VALUES (31, N'Dell Precision 7560', N'dell_precision7560.jpg', CAST(55990.00 AS Decimal(10, 2)), 7, N'C007', N'B003', CAST(N'2023-11-20' AS Date), CAST(N'2028-11-20' AS Date))
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [usingDate]) VALUES (32, N'MSI WS76', N'msi_ws76.jpg', CAST(60990.00 AS Decimal(10, 2)), 5, N'C007', N'B007', CAST(N'2023-12-15' AS Date), CAST(N'2029-12-15' AS Date))
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [usingDate]) VALUES (33, N'Asus ProArt StudioBook Pro X', N'asus_proartstudiobookx.jpg', CAST(65990.00 AS Decimal(10, 2)), 4, N'C007', N'B002', CAST(N'2024-01-22' AS Date), CAST(N'2029-01-22' AS Date))
GO
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__tblDisco__357D4CF9BF816DBD]    Script Date: 03/04/25 11:13:01 PM ******/
...
REFERENCES [dbo].[tblOrders] ([orderID])
GO
ALTER TABLE [dbo].[tblProductDetails]  WITH CHECK ADD FOREIGN KEY([productID])
REFERENCES [dbo].[tblProducts] ([productID])
ON DELETE CASCADE
GO
...
GO
ALTER TABLE [dbo].[tblProductViews]  WITH CHECK ADD FOREIGN KEY([productID])
REFERENCES [dbo].[tblProducts] ([productID])
GO
ALTER TABLE [dbo].[tblProductViews]  WITH CHECK ADD FOREIGN KEY([userID])
REFERENCES [dbo].[tblUsers] ([userID])
GO
ALTER TABLE [dbo].[tblReviews]  WITH CHECK ADD FOREIGN KEY([productID])
REFERENCES [dbo].[tblProducts] ([productID])
GO
