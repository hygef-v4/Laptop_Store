USE [master]
GO
/****** Object:  Database [LaptopStore2]    Script Date: 03/05/25 02:58:38 PM ******/
CREATE DATABASE [LaptopStore2]
 
USE [LaptopStore2]
GO
/****** Object:  Table [dbo].[tblBrands]    Script Date: 03/05/25 02:58:39 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[tblCarts]    Script Date: 03/05/25 02:58:39 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblCategories]    Script Date: 03/05/25 02:58:39 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblDiscounts]    Script Date: 03/05/25 02:58:39 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblOrderDetails]    Script Date: 03/05/25 02:58:39 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblOrders]    Script Date: 03/05/25 02:58:39 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblPayments]    Script Date: 03/05/25 02:58:39 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblProductDetails]    Script Date: 03/05/25 02:58:39 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblProducts]    Script Date: 03/05/25 02:58:39 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblProductViews]    Script Date: 03/05/25 02:58:39 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblReviews]    Script Date: 03/05/25 02:58:39 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblRoles]    Script Date: 03/05/25 02:58:39 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblShipping]    Script Date: 03/05/25 02:58:39 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblUsers]    Script Date: 03/05/25 02:58:39 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblWishlist]    Script Date: 03/05/25 02:58:39 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured]) VALUES (1, N'MSI Katana GF66', N'https://cdn2.fptshop.com.vn/unsafe/750x0/filters:quality(100)/2022_10_19_638017841585071699_msi-gaming-katana-gf66-12u-den-1.jpg', 16490000, 18, N'C001', N'B007', CAST(N'2023-03-15' AS Date), 12, 1)
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured]) VALUES (2, N'Acer Nitro 5', N'https://cdn2.fptshop.com.vn/unsafe/750x0/filters:quality(100)/2021_7_5_637610884165519217_acer-nitro-gaming-an515-57-den-1.jpg', 20990000, 25, N'C001', N'B005', CAST(N'2023-05-10' AS Date), 12, 1)
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured]) VALUES (3, N'Asus TUF Gaming F15', N'https://cdn2.fptshop.com.vn/unsafe/750x0/filters:quality(100)/2023_7_4_638240754677083179_asus-tuf-gaming-fx507-xam-1.jpg', 22990000, 22, N'C001', N'B002', CAST(N'2023-06-18' AS Date), 12, 1)
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured]) VALUES (4, N'Dell G15', N'https://cdn2.fptshop.com.vn/unsafe/750x0/filters:quality(100)/2022_4_21_637861309658938216_dell-gaming-g15-5515-xam-1.jpg', 21990000, 20, N'C001', N'B003', CAST(N'2023-07-25' AS Date), 12, 1)
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured]) VALUES (5, N'Lenovo Legion 5', N'https://cdn2.fptshop.com.vn/unsafe/750x0/filters:quality(100)/2022_10_20_638018713259494423_lenovo-gaming-legion-5-15arh7-xam-dam-1.jpg', 25990000, 20, N'C001', N'B001', CAST(N'2023-01-01' AS Date), 12, 1)
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured]) VALUES (6, N'Asus ROG Zephyrus G14', N'https://cdn2.fptshop.com.vn/unsafe/750x0/filters:quality(100)/rog_zephyrus_g14_2024_ga403_gray_1_994724b4c6.png', 32990000, 15, N'C001', N'B002', CAST(N'2023-02-01' AS Date), 12, 1)
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured]) VALUES (7, N'Lenovo ThinkPad X1 Carbon', N'https://cdn2.fptshop.com.vn/unsafe/750x0/filters:quality(100)/thinkpad_x1_carbon_gen_12_haptic_touchpad_34054a60b6.png', 35990000, 15, N'C002', N'B001', CAST(N'2023-04-05' AS Date), 12, 1)
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured]) VALUES (8, N'HP Spectre x360', N'https://cdn2.fptshop.com.vn/unsafe/750x0/filters:quality(100)/2024_6_24_638548335557426654_a19blpa.jpg', 32990000, 18, N'C002', N'B004', CAST(N'2023-05-12' AS Date), 12, 0)
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured]) VALUES (9, N'Dell Latitude 7420', N'https://cdn2.fptshop.com.vn/unsafe/750x0/filters:quality(100)/dell_latitude_15_3540_9950b79986.png', 29990000, 20, N'C002', N'B003', CAST(N'2023-06-20' AS Date), 12, 0)
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured]) VALUES (10, N'Asus ExpertBook B9', N'https://cdn2.fptshop.com.vn/unsafe/750x0/filters:quality(100)/2022_10_26_638023821244393375_asus-expertbook-b5302-den-1.jpg', 27990000, 22, N'C002', N'B002', CAST(N'2023-07-15' AS Date), 12, 0)
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured]) VALUES (11, N'LG Gram 17', N'https://cdn2.fptshop.com.vn/unsafe/750x0/filters:quality(100)/2023_6_9_638219264347784098_lg-gram-16z90r-gah76a5-i7-1360p-xam-2.jpg', 26990000, 16, N'C002', N'B009', CAST(N'2023-08-22' AS Date), 12, 0)
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured]) VALUES (12, N'Dell XPS 13', N'https://cdn2.fptshop.com.vn/unsafe/750x0/filters:quality(100)/2021_9_15_637673094747847062_dell-xps-13-9310-2in1-bac-1.jpg', 28990000, 25, N'C002', N'B003', CAST(N'2023-03-01' AS Date), 12, 0)
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured]) VALUES (13, N'HP Envy 15', N'https://cdn2.fptshop.com.vn/unsafe/750x0/filters:quality(100)/hp_envy_x360_14_blue_ffb8a04fdd.png', 23990000, 30, N'C002', N'B004', CAST(N'2023-04-01' AS Date), 12, 0)
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured]) VALUES (14, N'HP Pavilion Aero 13', N'https://cdn2.fptshop.com.vn/unsafe/750x0/filters:quality(100)/2023_8_24_638284697135623321_hp-pavilion-aero-13-bac-1.jpg', 19990000, 30, N'C003', N'B004', CAST(N'2023-06-10' AS Date), 12, 0)
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured]) VALUES (15, N'Acer Swift 14 AI', N'https://cdn2.fptshop.com.vn/unsafe/750x0/filters:quality(100)/acer_swift_14_ai_sf14_51_53p9_1_aedddbf7aa.png', 21990000, 28, N'C003', N'B005', CAST(N'2023-07-18' AS Date), 12, 0)
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured]) VALUES (16, N'Asus ZenBook 14', N'https://cdn2.fptshop.com.vn/unsafe/750x0/filters:quality(100)/asus_zenbook_14_ux3405_blue_1_2b8d979b81.png', 23990000, 22, N'C003', N'B002', CAST(N'2023-08-25' AS Date), 12, 0)
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured]) VALUES (17, N'Dell Inspiron 14', N'https://cdn2.fptshop.com.vn/unsafe/750x0/filters:quality(100)/dell_inspiron_5440_blue_ee119867e4.png', 18990000, 35, N'C003', N'B003', CAST(N'2023-09-12' AS Date), 12, 0)
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured]) VALUES (18, N'Acer Swift 3', N'https://cdn2.fptshop.com.vn/unsafe/750x0/filters:quality(100)/2023_7_6_638242339490771203_acer-swift-3-sf314-512-vang-2.jpg', 18990000, 40, N'C003', N'B005', CAST(N'2023-05-01' AS Date), 12, 0)
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured]) VALUES (19, N'MacBook Air', N'https://cdn2.fptshop.com.vn/unsafe/750x0/filters:quality(100)/macbook_air_13_m3_midnight_1_368063bb53.png', 27990000, 35, N'C003', N'B006', CAST(N'2023-06-01' AS Date), 12, 0)
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured]) VALUES (20, N'MSI Creator Z16', N'https://cdn2.fptshop.com.vn/unsafe/750x0/filters:quality(100)/2023_6_16_638225119763649940_msi-gaming-creator-z16-xam-1.jpg', 46990000, 8, N'C004', N'B007', CAST(N'2023-06-05' AS Date), 12, 0)
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured]) VALUES (21, N'HP ZBook Studio', N'https://cdn2.fptshop.com.vn/unsafe/750x0/filters:quality(100)/00908901_hp_245_g10_a20tfpt_9ce2c339f9.png', 44990000, 10, N'C004', N'B004', CAST(N'2023-08-20' AS Date), 12, 0)
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured]) VALUES (22, N'Acer ConceptD 7', N'https://cdn2.fptshop.com.vn/unsafe/750x0/filters:quality(100)/2023_9_9_638298604983362410_acer-aspire-7-gaming-a715-76g-den-1.jpg', 42990000, 12, N'C004', N'B005', CAST(N'2023-09-15' AS Date), 12, 0)
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured]) VALUES (24, N'Dell XPS 17', N'https://cdn2.fptshop.com.vn/unsafe/750x0/filters:quality(100)/dell_xps_14_9440_graphite_1_ed2132563b.png', 43990000, 12, N'C005', N'B003', CAST(N'2023-07-01' AS Date), 12, 0)
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured]) VALUES (25, N'HP Spectre Folio', N'https://cdn2.fptshop.com.vn/unsafe/750x0/filters:quality(100)/2024_6_24_638548335557426654_a19blpa.jpg', 40990000, 15, N'C005', N'B004', CAST(N'2023-08-10' AS Date), 12, 0)
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured]) VALUES (26, N'Lenovo ThinkPad X1 Extreme', N'https://cdn2.fptshop.com.vn/unsafe/750x0/filters:quality(100)/thinkpad_x1_carbon_gen_12_haptic_touchpad_34054a60b6.png', 45990000, 10, N'C005', N'B001', CAST(N'2023-09-18' AS Date), 12, 0)
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured]) VALUES (27, N'MSI Prestige 14', N'https://cdn2.fptshop.com.vn/unsafe/750x0/filters:quality(100)/msi_prestige_14_ai_studio_c1u_1_5ab50baa17.png', 38990000, 14, N'C005', N'B007', CAST(N'2023-11-12' AS Date), 12, 0)
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured]) VALUES (28, N'MacBook Pro 16', N'https://cdn2.fptshop.com.vn/unsafe/750x0/filters:quality(100)/macbook_pro_16_m4_pro_max_silver_1_6f38aaf8d8.png', 55990000, 8, N'C005', N'B006', CAST(N'2023-10-01' AS Date), 12, 0)
GO
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__tblDisco__357D4CF924684122]    Script Date: 03/05/25 02:58:39 PM ******/
ALTER TABLE [dbo].[tblDiscounts] ADD UNIQUE NONCLUSTERED 
(
	[code] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
GO
ALTER TABLE [dbo].[tblOrders] ADD  CONSTRAINT [DF__tblOrders__order__534D60F1]  DEFAULT ('pending') FOR [orderStatus]
GO
