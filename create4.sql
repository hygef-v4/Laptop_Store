USE [master]
GO
/****** Object:  Database [LaptopStore2]    Script Date: 03/15/25 04:52:45 PM ******/
CREATE DATABASE [LaptopStore2]
 
USE [LaptopStore2]
GO
/****** Object:  Table [dbo].[tblBrands]    Script Date: 03/15/25 04:52:46 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[tblCarts]    Script Date: 03/15/25 04:52:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblCategories]    Script Date: 03/15/25 04:52:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblDiscounts]    Script Date: 03/15/25 04:52:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblOrderDetails]    Script Date: 03/15/25 04:52:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblOrders]    Script Date: 03/15/25 04:52:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblPayments]    Script Date: 03/15/25 04:52:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblProductDetails]    Script Date: 03/15/25 04:52:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblProducts]    Script Date: 03/15/25 04:52:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblProductViews]    Script Date: 03/15/25 04:52:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblReviews]    Script Date: 03/15/25 04:52:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblRoles]    Script Date: 03/15/25 04:52:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblShipping]    Script Date: 03/15/25 04:52:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblUsers]    Script Date: 03/15/25 04:52:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblWishlist]    Script Date: 03/15/25 04:52:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured], [description]) VALUES (21, N'HP ZBook Studio', N'https://cdn2.fptshop.com.vn/unsafe/750x0/filters:quality(100)/00908901_hp_245_g10_a20tfpt_9ce2c339f9.png', 44990000, 10, N'C004', N'B004', CAST(N'2023-08-20' AS Date), 12, 0, N'Laptop đồ họa chuyên dụng, trang bị card đồ họa mạnh, màn hình sắc nét, hỗ trợ thiết kế và dựng phim.')
GO
...
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured], [description]) VALUES (28, N'MacBook Pro 16', N'https://cdn2.fptshop.com.vn/unsafe/750x0/filters:quality(100)/macbook_pro_16_m4_pro_max_silver_1_6f38aaf8d8.png', 55990000, 8, N'C005', N'B006', CAST(N'2023-10-01' AS Date), 12, 0, N'Laptop cao cấp với thiết kế tinh tế, hiệu suất mạnh mẽ, màn hình chất lượng cao dành cho doanh nhân.')
GO
...
GO
INSERT [dbo].[tblUsers] ([userID], [fullName], [username], [password], [roleID], [address], [phone], [email], [activate]) VALUES (1, N'Nguyễn Văn A', N'admin', N'admin', 1, N'Hà Nội', N'0123456789', N'a@example.com', 1)
GO
INSERT [dbo].[tblUsers] ([userID], [fullName], [username], [password], [roleID], [address], [phone], [email], [activate]) VALUES (2, N'Nguyễn Thị B', N'user2', N'123', 2, N'Hải Phòng', N'0987654321', N'b@example.com', 1)
GO
...
GO
INSERT [dbo].[tblUsers] ([userID], [fullName], [username], [password], [roleID], [address], [phone], [email], [activate]) VALUES (6, N'Default Name', N'user6', N'123', 2, N'', N'', N'', 1)
GO
INSERT [dbo].[tblUsers] ([userID], [fullName], [username], [password], [roleID], [address], [phone], [email], [activate]) VALUES (7, N'Default Name', N'user7', N'user7', 2, N'', N'', N'', 1)
GO
INSERT [dbo].[tblUsers] ([userID], [fullName], [username], [password], [roleID], [address], [phone], [email], [activate]) VALUES (8, N'Default Name', N'user8', N'user8', 2, N'', N'', N'', 1)
GO
SET IDENTITY_INSERT [dbo].[tblUsers] OFF
GO
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__tblDisco__357D4CF924684122]    Script Date: 03/15/25 04:52:46 PM ******/
...
GO
ALTER TABLE [dbo].[tblCarts]  WITH CHECK ADD  CONSTRAINT [FK__tblCarts__userID__59063A47] FOREIGN KEY([userID])
REFERENCES [dbo].[tblUsers] ([userID])
GO
ALTER TABLE [dbo].[tblCarts] CHECK CONSTRAINT [FK__tblCarts__userID__59063A47]
GO
