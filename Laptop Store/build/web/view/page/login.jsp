                            ...
                            <div class="col-lg-10 mx-auto">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <!--                                           login bang gg-->
                                        <div style="margin-top: 10px" class="d-flex gap-3 flex-column w-100 ">
                                            <a href="https://accounts.google.com/o/oauth2/auth?scope=email profile openid &redirect_uri=http://localhost:9999/Laptop_Store/authen?action=login-google&response_type=code&client_id=607777252028-jnotop79k58ald86vl2lghd22nqhei5o.apps.googleusercontent.com&approval_prompt=force" class="btn btn-lg btn-danger">
