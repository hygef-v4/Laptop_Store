        ...
        <main class="main">
            <div class="home-slider slide-animate owl-carousel owl-theme show-nav-hover nav-big mb-2 text-uppercase" data-owl-options="{
                ...
                <div class="home-slide home-slide1 banner">
                    <img class="slide-bg" src="${pageContext.request.contextPath}/assets/images/demoes/demo4/slider/slide-1.jpg" width="1903" height="499" alt="slider image">
                    <div class="container d-flex align-items-center">
                        <div class="banner-layer appear-animate" data-animation-name="fadeInUpShorter">
                            ...
                            <a href="category.jsp" class="btn btn-dark btn-lg">Shop Now!</a>
                        </div>
                        <!-- End .banner-layer -->
                    </div>
                </div>
                ...
                <div class="home-slide home-slide2 banner banner-md-vw">
                    <img class="slide-bg" style="background-color: #ccc;" width="1903" height="499" src="${pageContext.request.contextPath}/assets/images/demoes/demo4/slider/slide-2.jpg" alt="slider image">
                    <div class="container d-flex align-items-center">
                        <div class="banner-layer d-flex justify-content-center appear-animate" data-animation-name="fadeInUpShorter">
                            <div class="mx-auto">
                                ...
                                <a href="category.jsp" class="btn btn-block btn-dark">Shop All Sale</a>
                            </div>
                        </div>
                        <!-- End .banner-layer -->
                    </div>
                    ...
                    <div class="banner banner-big-sale appear-animate" data-animation-delay="200" data-animation-name="fadeInUpShorter" style="background: #2A95CB center/cover url('assets/images/demoes/demo4/banners/banner-4.jpg');">
                        <div class="banner-content row align-items-center mx-0">
                            ...
                            <div class="col-md-3 col-sm-4 text-center text-sm-right">
                                <a class="btn btn-light btn-white btn-lg" href="category.jsp">View Sale</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="promo-banner banner container text-uppercase">
                    <div class="banner-content row align-items-center text-center">
                        ...
                        <div class="col-md-4 col-xl-3 pb-4 pb-md-0 appear-animate" data-animation-name="fadeIn" data-animation-delay="300">
                            <a href="category.jsp" class="btn btn-dark btn-black ls-10">View Sale</a>
                        </div>
            ...
            <section class="blog-section pb-0">
                <div class="container">
                    ...
                    <div class="owl-carousel owl-theme appear-animate" data-animation-name="fadeIn" data-owl-options="{
                        ...
                        <article class="post">
                            <div class="post-media">
                                <a href="single.jsp">
                                    <img src="${pageContext.request.contextPath}/assets/images/blog/home/post-1.jpg" alt="Post" width="225" height="280">
                                </a>
                                <div class="post-date">
                        ...
                        <article class="post">
                            <div class="post-media">
                                <a href="single.jsp">
                                    <img src="${pageContext.request.contextPath}/assets/images/blog/home/post-2.jpg" alt="Post" width="225" height="280">
                                </a>
                                <div class="post-date">
                                    <span class="day">26</span>
                                    <span class="month">Feb</span>
                            ...
                            <div class="post-body">
                                <h2 class="post-title">
                                    <a href="single.jsp">Fashion Trends</a>
                                </h2>
                                <div class="post-content">
                        ...
                        <article class="post">
                            <div class="post-media">
                                <a href="single.jsp">
                                    <img src="${pageContext.request.contextPath}/assets/images/blog/home/post-3.jpg" alt="Post" width="225" height="280">
                                </a>
                                <div class="post-date">
                                    <span class="day">26</span>
                                    <span class="month">Feb</span>
                            ...
                            <div class="post-body">
                                <h2 class="post-title">
                                    <a href="single.jsp">Right Choices</a>
                                </h2>
                                <div class="post-content">
                        ...
                        <article class="post">
                            <div class="post-media">
                                <a href="single.jsp">
                                    <img src="${pageContext.request.contextPath}/assets/images/blog/home/post-4.jpg" alt="Post" width="225" height="280">
                                </a>
                                <div class="post-date">
                                    <span class="day">26</span>
                                    <span class="month">Feb</span>
                            ...
                            <div class="post-body">
                                <h2 class="post-title">
                                    <a href="single.jsp">Perfect Accessories</a>
                                </h2>
                                <div class="post-content">
                                    <p>Leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of...</p>
                                </div>
					...
					'margin': 0}">
                        <img src="${pageContext.request.contextPath}/assets/images/brands/brand1.png" width="130" height="56" alt="brand">
                        <img src="${pageContext.request.contextPath}/assets/images/brands/brand2.png" width="130" height="56" alt="brand">
                        <img src="${pageContext.request.contextPath}/assets/images/brands/brand3.png" width="130" height="56" alt="brand">
                        <img src="${pageContext.request.contextPath}/assets/images/brands/brand4.png" width="130" height="56" alt="brand">
                        <img src="${pageContext.request.contextPath}/assets/images/brands/brand5.png" width="130" height="56" alt="brand">
                        <img src="${pageContext.request.contextPath}/assets/images/brands/brand6.png" width="130" height="56" alt="brand">
                    </div>
                    <!-- End .brands-slider -->
                    ...
                    <div class="product-widgets-container row pb-2">
                        <div class="col-lg-3 col-sm-6 pb-5 pb-md-0 appear-animate" data-animation-name="fadeInLeftShorter" data-animation-delay="200">
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="product.jsp">
                                        <img src="${pageContext.request.contextPath}/assets/images/products/small/product-1.jpg" width="84" height="84" alt="product">
                                        <img src="${pageContext.request.contextPath}/assets/images/products/small/product-1-2.jpg" width="84" height="84" alt="product">
                                    </a>
                                </figure>
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="product.jsp">
                                        <img src="${pageContext.request.contextPath}/assets/images/products/small/product-2.jpg" width="84" height="84" alt="product">
                                        <img src="${pageContext.request.contextPath}/assets/images/products/small/product-2-2.jpg" width="84" height="84" alt="product">
                                    </a>
                                </figure>

                                <div class="product-details">
                                    <h3 class="product-title"> <a href="product.jsp">Brown Women Casual HandBag</a>
                                    </h3>
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="product.jsp">
                                        <img src="${pageContext.request.contextPath}/assets/images/products/small/product-3.jpg" width="84" height="84" alt="product">
                                        <img src="${pageContext.request.contextPath}/assets/images/products/small/product-3-2.jpg" width="84" height="84" alt="product">
                                    </a>
                                </figure>

                                <div class="product-details">
                                    <h3 class="product-title"> <a href="product.jsp">Circled Ultimate 3D Speaker</a>
                                    </h3>
                        ...
                        <div class="col-lg-3 col-sm-6 pb-5 pb-md-0 appear-animate" data-animation-name="fadeInLeftShorter" data-animation-delay="500">
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="product.jsp">
                                        <img src="${pageContext.request.contextPath}/assets/images/products/small/product-4.jpg" width="84" height="84" alt="product">
                                        <img src="${pageContext.request.contextPath}/assets/images/products/small/product-4-2.jpg" width="84" height="84" alt="product">
                                    </a>
                                </figure>

                                <div class="product-details">
                                    <h3 class="product-title"> <a href="product.jsp">Blue Backpack for the Young -
											S</a> </h3>
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="product.jsp">
                                        <img src="${pageContext.request.contextPath}/assets/images/products/small/product-5.jpg" width="84" height="84" alt="product">
                                        <img src="${pageContext.request.contextPath}/assets/images/products/small/product-5-2.jpg" width="84" height="84" alt="product">
                                    </a>
                                </figure>
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="product.jsp">
                                        <img src="${pageContext.request.contextPath}/assets/images/products/small/product-6.jpg" width="84" height="84" alt="product">
                                        <img src="${pageContext.request.contextPath}/assets/images/products/small/product-6-2.jpg" width="84" height="84" alt="product">
                                    </a>
                                </figure>
                        ...
                        <div class="col-lg-3 col-sm-6 pb-5 pb-md-0 appear-animate" data-animation-name="fadeInLeftShorter" data-animation-delay="800">
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="product.jsp">
                                        <img src="${pageContext.request.contextPath}/assets/images/products/small/product-7.jpg" width="84" height="84" alt="product">
                                        <img src="${pageContext.request.contextPath}/assets/images/products/small/product-7-2.jpg" width="84" height="84" alt="product">
                                    </a>
                                </figure>
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="product.jsp">
                                        <img src="${pageContext.request.contextPath}/assets/images/products/small/product-8.jpg" width="84" height="84" alt="product">
                                        <img src="${pageContext.request.contextPath}/assets/images/products/small/product-8-2.jpg" width="84" height="84" alt="product">
                                    </a>
                                </figure>
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="product.jsp">
                                        <img src="${pageContext.request.contextPath}/assets/images/products/small/product-9.jpg" width="84" height="84" alt="product">
                                        <img src="${pageContext.request.contextPath}/assets/images/products/small/product-9-2.jpg" width="84" height="84" alt="product">
                                    </a>
                                </figure>
                        ...
                        <div class="col-lg-3 col-sm-6 pb-5 pb-md-0 appear-animate" data-animation-name="fadeInLeftShorter" data-animation-delay="1100">
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="product.jsp">
                                        <img src="${pageContext.request.contextPath}/assets/images/products/small/product-10.jpg" width="84" height="84" alt="product">
                                        <img src="${pageContext.request.contextPath}/assets/images/products/small/product-10-2.jpg" width="84" height="84" alt="product">
                                    </a>
                                </figure>

                                <div class="product-details">
                                    <h3 class="product-title"> <a href="product.jsp">Basketball Sports Blue Shoes</a>
                                    </h3>
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="product.jsp">
                                        <img src="${pageContext.request.contextPath}/assets/images/products/small/product-11.jpg" width="84" height="84" alt="product">
                                        <img src="${pageContext.request.contextPath}/assets/images/products/small/product-11-2.jpg" width="84" height="84" alt="product">
                                    </a>
                                </figure>
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="product.jsp">
                                        <img src="${pageContext.request.contextPath}/assets/images/products/small/product-12.jpg" width="84" height="84" alt="product">
                                        <img src="${pageContext.request.contextPath}/assets/images/products/small/product-12-2.jpg" width="84" height="84" alt="product">
                                    </a>
                                </figure>
...
<!--    <div class="newsletter-popup mfp-hide bg-img" id="newsletter-popup-form" style="background: #f1f1f1 no-repeat center/cover url(assets/images/newsletter_popup_bg.jpg)">
        <div class="newsletter-popup-content">
            <img src="${pageContext.request.contextPath}/assets/images/logo.png" width="111" height="44" alt="Logo" class="logo-newsletter">
